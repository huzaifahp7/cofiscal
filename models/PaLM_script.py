...
def generate_text_2(income, loan_amt, credit_score, interest_rate, loan_term, dti_ratio, loan_purp,prob_def):
    typ = {1:"Other",
           2:"Auto",
           3:"Business",
           4:"Home",
    ...
    if (float(prob_def)<0.50):
        prompt += '''Explain to me why I am on the safer side. Keep it as concise and specific as possible. Additionally, suggest why I should go ahead and take the loan 
