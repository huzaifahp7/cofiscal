...
const HomePage = () => {
  return (
    <div className="w-full flex justify-between h-[100vh] bg-gradient-to-br from-cyan-400 via-violet-700 to-violet-700 p-40">
      <div className="flex flex-col justify-start h-30%">
        ...
        <Link href={"/input"} className="mt-10 w-fit border-2 border-white rounded-3xl py-3 px-8">
